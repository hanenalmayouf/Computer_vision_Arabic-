...
counter = solutions.ObjectCounter(
    show=True, region=line_points, model="weights/yolo26n.pt"
)
...
## Demonstration: Object Counting {.center}
...
## Demonstration: Parking Management {.center}

{{< video assets/parking_slots.mp4 width="900" height="500" autoplay="true" loop="true" muted="true" >}}
...
## Demonstration: Speed Estimation {.center}
...
```python
video_path = "assets/Pull_ups.mp4"
if not os.path.exists(video_path):
    video_path = "slides/assets/Pull_ups.mp4"
...
if not os.path.exists(video_path):
    video_path = "slides/assets/videos/traffic.mp4"
cap = cv2.VideoCapture(video_path)
...
![Instance Segmentation Output](assets/slides/outputs/images/task-segmentation.png)
...
![Workouts Monitoring Output](assets/slides/outputs/images/task-pose.png)
