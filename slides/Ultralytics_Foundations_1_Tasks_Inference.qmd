...
## From `probs` to `top1` — Ultralytics Does It For You
...
![Classification Real Output](outputs/classification_output.png)
...
![Detection Real Output](outputs/detection_output.png)
...
![Segmentation Real Output](outputs/segmentation_output.png)
...
![Pose Real Output](outputs/pose_output.png)
...
![OBB Real Output](outputs/obb_output.png)
...
![Tracking Real Output](outputs/tracking_output.avif)
